...
const STAGE_VERTICAL_LEGENDS: Record<Vertical, Record<Stage, Legend[]>> = {
  "Enterprise SaaS": {
    "Seed": [
      { name: "Webflow", result: "$1M in 12mo", logo: "/logos/webflow.svg?v=4", highlight: "PLG wedge mastery" },
      { name: "Mercury", result: "$1M in 6mo", logo: "/logos/mercury.svg?v=4", highlight: "Brand trust outlier" }
    ],
    "Series A": [
      { name: "Slack", result: "$10M in 12mo", logo: "/logos/slack.svg?v=4", highlight: "Enterprise viral loop" },
      { name: "Klaviyo", result: "$20M+ ARR", logo: "/logos/klaviyo.svg?v=4", highlight: "Mastered high-velocity ROI" }
    ],
    "Series B": [
      { name: "Brex", result: "$100M in 24mo", logo: "/logos/brex.svg?v=4", highlight: "Fintech infra blitz" },
      { name: "HubSpot", result: "Hyper-efficient scale", logo: "/logos/hubspot.svg?v=4", highlight: "GTM platform standard" }
    ],
    "Series C+": [
      { name: "Stripe", result: "$1B+ ARR", logo: "/logos/stripe.svg?v=4", highlight: "Global payment velocity" },
      { name: "Salesforce", result: "The OG GTM Giant", logo: "/logos/salesforce.svg?v=4", highlight: "Created the category" }
    ],
  },
  "AI Infrastructure": {
    "Seed": [
      { name: "Cursor", result: "$1M in 4mo", logo: "/logos/cursor.svg?v=4", highlight: "The hypergrowth record" },
    ...
    "Series B": [
      { name: "ElevenLabs", result: "$50M in 12mo", logo: "/logos/elevenlabs.svg?v=4", highlight: "Voice AI category leader" },
      { name: "Mistral", result: "$100M+ valuation burst", logo: "/logos/mistral.svg?v=4", highlight: "Open-source efficiency" }
    ],
    "Series C+": [
      { name: "OpenAI", result: "$3B+ ARR", logo: "/logos/openai.svg?v=4", highlight: "Defining the AI business model" },
      { name: "Anthropic", result: "Enterprise AI standard", logo: "/logos/anthropic.svg?v=4", highlight: "Safety-first scaling" }
    ],
  },
  "Fintech": {
    "Seed": [
      { name: "Mercury", result: "Startup Banking", logo: "/logos/mercury.svg?v=4", highlight: "Seamless UX wedge" },
      { name: "Unit", result: "Embedded Finance", logo: "/logos/unit.svg?v=4", highlight: "Infrastructure-first" }
    ],
    "Series A": [
      { name: "Ramp", result: "$10M in 12mo", logo: "/logos/ramp.svg?v=4", highlight: "$100M ARR speedrun record" },
      { name: "Deel", result: "Global Compliance", logo: "/logos/deel.svg?v=4", highlight: "Horizontal scale speed" }
    ],
    "Series B": [
      { name: "Brex", result: "$100M in 24mo", logo: "/logos/brex.svg?v=4", highlight: "Market share blitz" },
      { name: "Navan", result: "Travel Fintech", logo: "/logos/navan.svg?v=4", highlight: "Enterprise consolidation" }
    ],
    "Series C+": [
      { name: "Stripe", result: "$1B+ ARR", logo: "/logos/stripe.svg?v=4", highlight: "Internet economy infra" },
      { name: "Adyen", result: "Global Payments", logo: "/logos/adyen.svg?v=4", highlight: "Operational excellence" }
    ],
  },
  "Cybersecurity": {
    "Seed": [
      { name: "Oleria", result: "Identity Security", logo: "/logos/oleria.svg?v=4", highlight: "AI-native security" },
      { name: "Sentra", result: "Data Security", logo: "/logos/sentra.svg?v=4", highlight: "Cloud-speed scaling" }
    ],
    "Series A": [
      { name: "Abnormal", result: "Email AI", logo: "/logos/abnormal.svg?v=4", highlight: "Fastest security scale-up" },
      { name: "Orca", result: "Agentless Security", logo: "/logos/orca.svg?v=4", highlight: "Frictionless deployment" }
    ],
    "Series B": [
      { name: "Wiz", result: "$100M in 18mo", logo: "/logos/wiz.svg?v=4", highlight: "Growth record holder" },
      { name: "Snyk", result: "Developer Security", logo: "/logos/snyk.svg?v=4", highlight: "Mastered the dev wedge" }
    ],
    "Series C+": [
      { name: "CrowdStrike", result: "$3B+ ARR", logo: "/logos/crowdstrike.svg?v=4", highlight: "Platform dominance" },
      { name: "Zscaler", result: "Zero Trust Leader", logo: "/logos/zscaler.svg?v=4", highlight: "Cloud-native infra" }
    ],
  },
  "DevTools": {
    "Seed": [
      { name: "Supabase", result: "$1M in 9mo", logo: "/logos/supabase.svg?v=4", highlight: "The Firebase alternative" },
      { name: "Resend", result: "Email for Devs", logo: "/logos/resend.svg?v=4", highlight: "Elite UX-led growth" }
    ],
    "Series A": [
      { name: "Cognition", result: "$73M in 9mo", logo: "/logos/cognition.svg?v=4", highlight: "Agentic dev standard" },
      { name: "Cursor", result: "AI-Native Coding", logo: "/logos/cursor.svg?v=4", highlight: "Redefining the IDE" }
    ],
    "Series B": [
      { name: "Vercel", result: "$50M in 24mo", logo: "/logos/vercel.svg?v=4", highlight: "Frontend cloud standard" },
      { name: "PostHog", result: "OS Product OS", logo: "/logos/posthog.svg?v=4", highlight: "Community-led outlier" }
    ],
    "Series C+": [
      { name: "GitHub", result: "$1B+ ARR", logo: "/logos/github.svg?v=4", highlight: "Global developer OS" },
      { name: "GitLab", result: "DevSecOps Leader", logo: "/logos/gitlab.svg?v=4", highlight: "Remote-first scale" }
    ],
  },
};
